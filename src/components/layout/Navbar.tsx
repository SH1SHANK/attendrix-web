          ...
          <div className="flex items-center justify-between h-14 md:h-16">
            ...
            <div className="flex items-center gap-3">
              {user ? (
                ...
                <Link
                  href="/auth/signup"
                  className="hidden sm:inline-flex items-center justify-center px-6 py-2 bg-[#FFD02F] text-black border-2 border-black font-bold uppercase text-xs tracking-wider shadow-[4px_4px_0px_0px_#000] transition-all duration-300 hover:-translate-y-[2px] hover:-translate-x-[2px] hover:shadow-[6px_6px_0px_0px_#000] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none"
                >
                  Get Started
                </Link>
              )}
